...
package object elem {
    ...
    object styles extends BaseStyleMapping("doms") {
        import rules._

        val color = rules.color

        Mammal --> color("#f8f7f7")
        Reptile --> color("#57565b")
        Bird --> color("#f7da09")
        Amphibian --> color("#017dd6")
        Arachnid --> color("#ef1c18")
        Insect --> color("#63a730")
        ...
        Forest --> color("#42692f")
        Jungle --> color("#0d4724")
        Mountain --> color("#594a32")
        Savannah --> color("#546731")
        Sea --> color("#0e5a8b")
        Tundra --> color("#ebf1f8")
        Wetland --> color("#28736f")

        object title extends CustomStyle(font.family("chiller"))

        object token extends CustomStyle(height("2.8ex"), vertical.align("middle"), margin.top("0.1ex"), margin.bottom("0.1ex"))
        object cylinder extends CustomStyle(height("2.8ex"), vertical.align("middle"), margin.top("0.1ex"), margin.bottom("0.1ex"), margin.left("0.1ex"), margin.right("0.1ex"))
        object cube extends CustomStyle(height("2.2ex"), vertical.align("middle"), margin.top("0.3ex"), margin.bottom("0.3ex"), margin.left("0ex"), margin.right("0ex"))

        object tokenBig extends CustomStyle(height("8ex"), vertical.align("middle"), margin.top("0.1ex"), margin.bottom("0.1ex"))
        ...
        object card0 extends CustomStyle(padding("2px"), padding("0.2ex"), margin("0px"), margin("0.0ex"), border.color("transparent"), border.style("solid"), border.width("0.3ex"))
        ...
        object resLine extends CustomStyle()
    ...
    implicit class ElemInt(val n : Int) extends AnyVal {
        def vp = (n >= 0).?(0x27C5.toChar.toString.hh.styled(xstyles.smaller75) ~ n.styled(xstyles.bold).styled(styles.vp) ~ 0x27C6.toChar.toString.hh.styled(xstyles.smaller75)).|(("-" + n.abs + "P").styled(styles.hit))
    ...
    object borders extends BaseStyleMapping("doms-border") {
        import rules._

        Mammal --> outline.color("#7c7b7b")
        Reptile --> outline.color("#2b2b2d")
        Bird --> outline.color("#7b6d04")
        Amphibian --> outline.color("#003e6b") // #017dd6
        Arachnid --> outline.color("#770e0c")
        Insect --> outline.color("#315318")
    }
}
